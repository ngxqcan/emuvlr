...
static constexpr double TASK_RETRY_BACKOFF_SEC = 30.0;
static constexpr double TASK_PROBE_INTERVAL_SEC = 15.0;
static constexpr double TASK_PROBE_INTERVAL_BUSY_SEC = 5.0;
static constexpr int MAX_PROBE_QUEUE = 48;
static constexpr int PROBE_QUEUE_PRESSURE = 28;
static constexpr int PROBE_401_BACKOFF_SEC = 600;
